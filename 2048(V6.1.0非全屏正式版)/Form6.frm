...
Sub ShowTransparency(cSrc As PictureBox, cDest As Form, ByVal nLevel As Byte)
    ...
    With cSrc
        AlphaBlend cDest.hDC, (Loading.ScaleWidth - Picture1.Width) / 2, (Loading.ScaleHeight - Picture1.Height) / 2, .ScaleWidth, .ScaleHeight, .hDC, 0, 0, .ScaleWidth, .ScaleHeight, LnBlendPtr   '非全屏模式独有
    End With
    cDest.Refresh
End Sub
...
Private Sub Timer1_Timer() '全屏与非全屏不同的过程
    If lTime < 254 Then
        ...
        RichTextBox1.Width = Loading.ScaleWidth * lTime / 255
